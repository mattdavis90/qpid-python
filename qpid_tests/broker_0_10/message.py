...
class MessageTests(TestBase010):
    ...
    def test_consume_queue_not_specified(self):
        ...
        try:
            ...
            self.assertEqual(531, e.args[0].error_code)
    ...
    def test_ack(self):
        ...
        self.assertEqual(queueObj.msgDepth, 5)
        self.assertEqual(queueObj.msgTotalEnqueues, 5)
        self.assertEqual(queueObj.msgTotalDequeues, 0)
        ...
        self.assertEqual(0, session1.queue_query(queue="test-ack-queue").message_count)
        queueObj.update()
        self.assertEqual(queueObj.msgDepth, 2)
        self.assertEqual(queueObj.msgTotalEnqueues, 5)
        self.assertEqual(queueObj.msgTotalDequeues, 3)
        ...
        queueObj.update()
        self.assertEqual(queueObj.msgDepth, 0)
        self.assertEqual(queueObj.msgTotalEnqueues, 5)
        self.assertEqual(queueObj.msgTotalDequeues, 5)
    ...
    def test_reject(self):
        ...
        self.assertEqual(msg.body, "blah, blah")
    ...
    def test_subscribe_not_acquired(self):
        ...
        for i in range(1, 11):
            for q in [qA, qB]:
                msg = q.get(timeout = 1)
                self.assertEqual("Message %s" % i, msg.body)
        ...
        self.assertEqual(10, session.queue_query(queue = "q").message_count)
    ...
    def test_acquire_with_no_accept_and_credit_flow(self):
        ...
        self.assertEqual("acquire me", msg.body)
        ...
        self.assertTrue(msg.id in response.transfers)
    ...
    def test_release(self):
        ...
        session.message_flow(destination="a", unit=session.credit_unit.byte, value=0xFFFFFFFF)
        msg = session.incoming("a").get(timeout = 1)
        self.assertEqual("release me", msg.body)
    ...
    def test_release_ordering(self):
        ...
        for i in range(2, 10):
            ...
            self.assertEqual("released message %s" % (i), msg.body)
        ...
        for i in range(1, 11):
            self.assertEqual("released message %s" % (i), queue.get(timeout = 1).body)
    ...
    def test_ranged_ack(self):
        ...
        self.assertEqual("message 4", queue.get(timeout = 1).body)
        self.assertEmpty(queue)
