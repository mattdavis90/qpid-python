...
class QueryTests(TestBase010):
    ...
    def test_queue_query_unknown(self):
        ...
        self.assertTrue(not result.queue)
    ...
    def test_exchange_query(self):
        ...
        self.assertTrue(not response.durable)
        self.assertTrue(not response.not_found)
        #delete the exchange
        session.exchange_delete(exchange="my-test-exchange")
        #check that the query now reports not-found
        self.assertTrue(session.exchange_query(name="my-test-exchange").not_found)
    ...
    def exchange_bound_with_key(self, exchange_name):
        ...
        self.assertTrue(not response.exchange_not_found)
        self.assertTrue(not response.queue_not_found)
        self.assertTrue(not response.queue_not_matched)        
        ...
        self.assertTrue(not response.exchange_not_found)
        self.assertTrue(not response.queue_not_found)
        self.assertTrue(not response.key_not_matched)        
    ...
    def test_exchange_bound_header(self):
        ...
        self.assertTrue(not response.exchange_not_found)
        self.assertTrue(not response.queue_not_found)
        self.assertTrue(not response.args_not_matched)        
